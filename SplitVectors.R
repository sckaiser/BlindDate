SplitVectors <- function(x, n) {
  ...
  #  n, the number of new vectors into which x should be split.
  # Returns:
  #  a list of n vectors.
  seq1 <- seq(1, length(x) + 1 - n, by = n)  # baseline sequence for splitting
  # Next: Create subsequent sequences
}

x <- c(12, 1, 2015, 11, 29, 2015)
n <- 3
